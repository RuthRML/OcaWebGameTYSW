...
public class Tablero {
	...
	Tablero() {
		...
		this.casillas[17].setMensaje(de_Oca_A_Oca);
		this.casillas[22].setSiguiente(this.casillas[26]);
		this.casillas[22].setMensaje(de_Oca_A_Oca);
		this.casillas[26].setSiguiente(this.casillas[31]);
		this.casillas[26].setMensaje(de_Oca_A_Oca);
		this.casillas[31].setSiguiente(this.casillas[35]);
		this.casillas[31].setMensaje(de_Oca_A_Oca);
		this.casillas[35].setSiguiente(this.casillas[40]);
		this.casillas[35].setMensaje(de_Oca_A_Oca);
		this.casillas[40].setSiguiente(this.casillas[44]);
		this.casillas[40].setMensaje(de_Oca_A_Oca);
		this.casillas[44].setSiguiente(this.casillas[49]);
		this.casillas[44].setMensaje(de_Oca_A_Oca);
		this.casillas[49].setSiguiente(this.casillas[53]);
		...
		// Puentes
		this.casillas[5].setSiguiente(this.casillas[11]);
		this.casillas[5].setMensaje(dePuenteAPuente);
		this.casillas[11].setSiguiente(this.casillas[5]);
		this.casillas[11].setMensaje(dePuenteAPuente);

		// Dados
		this.casillas[25].setSiguiente(this.casillas[52]);
		this.casillas[25].setMensaje(deDadoADado);
